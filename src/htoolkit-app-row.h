...
#ifndef HTOOLKIT_APP_ROW_H
#define HTOOLKIT_APP_ROW_H
...
#define HTOOLKIT_TYPE_APP_ROW (htoolkit_app_row_get_type ())

G_DECLARE_DERIVABLE_TYPE (HToolkitAppRow, htoolkit_app_row, HTOOLKIT, APP_ROW, GtkListBoxRow)

struct _HToolkitAppRowClass
{
